...
#define IR_Key_Reset                          0xE0E0629D  // Stop (@TV)           // Сброс всех настроек и перезагрузка 
#define IR_Key_Demo                           0xFFB04F  // #                      // Включит демо режим (перебор) 
...
#define IR_Key_Speed_minus                    0xFF4AB5  // DOWN                   // Замедлить движение
#define IR_Key_Speed_plus                     0xFF18E7  // UP                     // Ускорить движение

#define IR_Key_Glitter                        0xFF38C7  // OK                     // Включить/выключить сверкание
//#define IR_Key_BackGround                   0xFFE817  // Time                   // Включить/выключить заполнение фона
#define IR_Key_Candle                         0xFF6897  // *                      // Включить/выключить свечки

#define IR_Key_Previous_mode                  0xFF10EF  // LEFT                   // Предыдущий эффект. Отключает демонстрационный режим
#define IR_Key_Next_mode                      0xFF5AA5  // RIGHT                  // Следующий эффект. Отключает демонстрационный режим
...
#define IR_Key_SetMode_0                    0xFF9867  //0                       // Набор номера выбор эффекта сдвиг + кнопка 0
#define IR_Key_SetMode_1                    0xFFA25D  //1                       // Набор номера выбор эффекта сдвиг + кнопка 1
#define IR_Key_SetMode_2                    0xFF629D  //2                       // Набор номера выбор эффекта сдвиг + кнопка 2
#define IR_Key_SetMode_3                    0xFFE21D  //3                       // Набор номера выбор эффекта сдвиг + кнопка 3
#define IR_Key_SetMode_4                    0xFF22DD  //4                       // Набор номера выбор эффекта сдвиг + кнопка 4
#define IR_Key_SetMode_5                    0xFF02FD  //5                       // Набор номера выбор эффекта сдвиг + кнопка 5
#define IR_Key_SetMode_6                    0xFFC23D  //6                       // Набор номера выбор эффекта сдвиг + кнопка 6
#define IR_Key_SetMode_7                    0xFFE01F  //7                       // Набор номера выбор эффекта сдвиг + кнопка 7
#define IR_Key_SetMode_8                    0xFFA857  //8                       // Набор номера выбор эффекта сдвиг + кнопка 8
#define IR_Key_SetMode_9                    0xFF906F  //9                       // Набор номера выбор эффекта сдвиг + кнопка 9
